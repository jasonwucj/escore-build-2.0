...
--chroot "lorax -p NewESCore -v 7.3 -r 7.3 -s http://localhost/ESCore/CentOS/7.3.1611/os/x86_64 -s http://localhost/ESCore/CentOS/7.3.1611/easystack/x86_64 --isfinal /buildiso/result"
