...
/usr/bin/mock -r centos-7-x86_64.cfg --rootdir `pwd`/chroot/ --install http://localhost/ESCore/CentOS/7.3.1611/easystack/x86_64/Packages/lorax-19.6.78-1.el7.1.x86_64.rpm
